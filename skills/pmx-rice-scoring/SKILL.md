---
name: pmx-rice-scoring
description: Apply the RICE framework to compare initiatives consistently.
---
...
### Skill-specific lens
1. Estimate reach, impact, confidence, and effort.
2. Show the scoring math clearly.
3. Highlight where estimates are weakest.
4. Translate scores into a recommendation.
